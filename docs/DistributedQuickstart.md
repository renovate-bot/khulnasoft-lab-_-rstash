rstash distributed compilation quickstart
==========================================
...
As with the scheduler, if the build server fails to start you may need to set `RSTASH_LOG=trace` to get useful diagnostics.
