...
if [ "$1" = checkall ]; then
    ...
    # Musl tests segfault due to https://github.com/khulnasoft-lab/rstash/issues/256#issuecomment-399254715
    gnutarget
    VERBOSE=
    NOCAPTURE=
    NORUN=
    ...
    # Since integration tests start up the rstash server they must be run sequentially. This only matters
