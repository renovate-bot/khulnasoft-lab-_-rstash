...
/// A connection to an rstash server.
...
/// Establish a TCP connection to an rstash server listening on `addr`.
...
/// Attempt to establish a TCP connection to an rstash server listening on `addr`.
///
