        ...
        match arg.get_data() {
            ...
            Some(CodeGen(ArgCodegen { opt, value })) => {
                match (opt.as_ref(), value) {
                    ...
                    // Incremental compilation makes a mess of rstash's entire world
                    ...
                    // rstash and rustc in the incremental scenario:
                    // https://github.com/khulnasoft-lab/rstash/issues/236
...
fn can_trim_this(input_path: &Path) -> bool {
    ...
    // https://bugzilla.khulnasoft.com/show_bug.cgi?id=1760743
    input_path
        .extension()
...
fn test_rust_outputs_rewriter() {
    ...
    let depinfo_data = format!("{prefix}/rstash/target/x86_64-unknown-linux-gnu/debug/deps/rstash_dist-c6f3229b9ef0a5c3.rmeta: src/bin/rstash-dist/main.rs src/bin/rstash-dist/build.rs src/bin/rstash-dist/token_check.rs

{prefix}/rstash/target/x86_64-unknown-linux-gnu/debug/deps/rstash_dist-c6f3229b9ef0a5c3.d: src/bin/rstash-dist/main.rs src/bin/rstash-dist/build.rs src/bin/rstash-dist/token_check.rs

src/bin/rstash-dist/main.rs:
src/bin/rstash-dist/build.rs:
src/bin/rstash-dist/token_check.rs:
", prefix=linux_prefix);

    let depinfo_resulting_data = format!("{prefix}/rstash/target/x86_64-unknown-linux-gnu/debug/deps/rstash_dist-c6f3229b9ef0a5c3.rmeta: src/bin/rstash-dist/main.rs src/bin/rstash-dist/build.rs src/bin/rstash-dist/token_check.rs
